...
@section('admin-content')
    <div class="page-wrapper">
        @include('components.page_header', [
            'title' => !empty($seller) ? __('labels.edit_seller') : __('labels.add_seller'),
            'step' => 2,
        ])
                            ...
                            <div class="col-12">
                                <form
                                    ...
                                    <div class="card mb-4" id="pills-basic">
                                        ...
                                        <div class="card-body">
                                            <div class="mb-3">
                                                <label class="form-label required">{{ __('labels.seller_name') }}</label>
                                                <input type="text"
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <select type="text"
                                                    ...
                                                    name="country" id="select-countries"
                                                    {{ !empty($seller) && $seller->country ? 'disabled' : '' }}>
                                                </select>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="tel"
                                                    ...
                                                    value="{{ old('mobile', $seller->user->mobile ?? '') }}"
                                        ...
                                        <div class="card-body">
                                            <div class="mb-3">
                                                ...
                                                <input type="text"
                                                    ...
                                                    name="address" placeholder="{{ __('labels.enter_address') }}"
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text"
                                                            ...
                                                            name="city" placeholder="{{ __('labels.enter_city') }}"
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text"
                                                            ...
                                                            name="state" placeholder="{{ __('labels.enter_state') }}"
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text"
                                                            ...
                                                            name="zipcode" placeholder="{{ __('labels.enter_zipcode') }}"
                                    ...
                                    <div class="card mb-4" id="pills-status">
                                        ...
                                        <div class="card-body">
                                            <div class="mb-3">
                                                ...
                                                <select
                                                    ...
                                                    <option value="approved"
                                                        {{ old('verification_status', $seller->verification_status ?? '') == 'approved' ? 'selected' : '' }}>
                                                        {{ __('labels.approved') }}
                                                    </option>
                                                    <option value="not_approved"
                                                        {{ old('verification_status', $seller->verification_status ?? '') == 'not_approved' ? 'selected' : '' }}>
                                            ...
                                            {{-- <div class="mb-3">
                                                ...
                                                <textarea class="form-control @error('metadata') is-invalid @enderror" name="metadata"
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <select
                                                    ...
                                                    <option value="visible"
                                                        {{ old('visibility_status', $seller->visibility_status ?? '') == 'visible' ? 'selected' : '' }}>
                                                        {{ __('labels.visible') }}
                                                    </option>
                                                    <option value="draft"
                                                        {{ old('visibility_status', $seller->visibility_status ?? '') == 'draft' ? 'selected' : '' }}>
                                                        {{ __('labels.draft') }}
                                                    </option>
                                                </select>
