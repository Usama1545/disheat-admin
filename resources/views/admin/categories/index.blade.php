@extends('layouts.admin.app', [
    'page' => $menuAdmin['categories']['active'] ?? '',
    'sub_page' => $menuAdmin['categories']['route']['categories']['sub_active'] ?? '',
])
...
@section('admin-content')
                ...
                <div class="card-table">
                    <div class="row w-full p-3">
                        ...
                        <x-datatable id="categories-table" :columns="$columns"
                            route="{{ route('admin.categories.datatable') }}" :options="['order' => [[0, 'desc']], 'pageLength' => 10]" />
                    </div>
                </div>
            </div>
        </div>
    ...
    @if (($createPermission ?? false) || ($editPermission ?? false))
        <div class="modal modal-blur fade" id="category-modal" tabindex="-1" role="dialog" aria-hidden="true"
                        ...
                        <div class="modal-body">
                            ...
                            <div class="mb-3" id="background-image-field" style="display: none;">
                                ...
                                <input type="file" class="form-control" id="background-image-upload"
                                    name="background_image" data-image-url="" />
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control" name="commission" id="commission"
                                    placeholder="{{ __('labels.commission_placeholder') }}" step="0.01"
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3 form-check form-switch">
                                        <input class="form-check-input" type="checkbox" name="status"
                                            id="status-switch" value="active" checked>
    ...
    @endif
    <div class="offcanvas offcanvas-end" tabindex="-1" id="view-category-offcanvas"
