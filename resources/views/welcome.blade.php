...
<head>
    ...
    <title>Disheat - Multivendor Delivery Platform</title>
...
<body>
    ...
    <div class="container">
        ...
        <section class="hero">
            ...
            <h1>Launch Your Own<br>Disheat Platform</h1>
        ...
        <section class="links-section">
            ...
            <div class="links-grid">
                <!-- Customer Website -->
                <a href="https://disheat.eshopweb.store" target="_blank" rel="noopener noreferrer" class="link-card">
                ...
                <!-- Vendor Website -->
                <a href="https://disheat-backend.eshopweb.store/seller/login" target="_blank" rel="noopener noreferrer"
                    class="link-card">
                    <div class="link-card-content">
                        <div class="link-icon">🏬</div>
                ...
                <div class="link-card">
                    <div class="link-card-content">
                        ...
                        <div class="app-buttons">
                            <a href="https://play.google.com/store/apps/details?id=com.disheat.partner" target="_blank"
                                rel="noopener noreferrer" class="store-button">
                                <img src="https://upload.wikimedia.org/wikipedia/commons/7/78/Google_Play_Store_badge_EN.svg"
                                    alt="Get it on Google Play" class="store-badge">
                            </a>
                ...
                <!-- Admin Panel -->
                <a href="https://disheat-backend.eshopweb.store/admin/login" target="_blank"
        ...
        <footer>
            <p class="footer-text">
                © {{ date('Y') }} Disheat Platform. All rights reserved. | Available on <a
                    href="https://1.envato.market/2aoKVD" target="_blank">CodeCanyon</a>
            </p>
            <p class="footer-text developer-credit">
                Designed & Developed with ❤️ by <a href="https://infinitietech.com" target="_blank"
                    rel="noopener">Infinitietech</a>
            </p>
        </footer>
    </div>
