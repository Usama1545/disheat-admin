...
">
        <div class="box shadow-sm border rounded-4">
            <div class="header" style="
                background: none;
            ">
                <img src="{{ asset('logos/logo.png') }}" class="mb-4" width="170px" alt="">
                <h1 class="header__title text-dark">HyperMart Installer – Disheat Multivendor Commerce Setup</h1>
            </div>
            <ul class="step">
                ...
                <li class="step__item {{ isActive('LaravelInstaller::environment') }}"><i
                        class="step__icon update"></i>
                </li>
                <li class="step__divider"></li>
                <li class="step__item {{ isActive('LaravelInstaller::welcome') }}"><i class="step__icon welcome"></i>
                </li>
                <li class="step__divider"></li>
            </ul>
            <div class="main">
